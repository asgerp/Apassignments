...
We constructed 54 tests that all yield the expected result.
...
Our program consists of pure rules and fact. None of our predicates enter into infinite loops and all of the them succeed only once.
